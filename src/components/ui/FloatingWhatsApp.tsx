...
export function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      {/* Tooltip hint */}
      <span className="absolute right-full mr-4 bg-white text-primary text-[0.6rem] uppercase tracking-widest font-bold py-2 px-4 rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap border border-gold/20">
        Agendar Horário
      </span>
